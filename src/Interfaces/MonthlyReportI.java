 ...
 * @author Yasiru
 */
public class MonthlyReportI extends javax.swing.JFrame {

    /**
     * Creates new form MonthlyReportI
     */
    public MonthlyReportI() {
        initComponents();
        ImageIcon myimage = new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("rep.png")));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MonthlyReportI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MonthlyReportI().setVisible(true);
            }
        });
    }
